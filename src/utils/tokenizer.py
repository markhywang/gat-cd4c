...
class BytePairTokenizer:
    """
    Class that implements Byte Pair Encoding.

    Instance Attributes:
        - merges: dictionary to store all merged indices
        - vocab: dict to convert tokenized indices to byte streams
        - index: index value for next minted byte pair
    ...
    def __init__(self) -> None:
        """Initializes byte pair encoder class"""
    ...
    def train(self, text: str, num_merges: int, init_utf: bool = True, verbose: bool = False) -> None:
        ...
        for _ in range(0, num_merges):
            ...
            if max(len(b) for b in byte_streams) <= 1:
                break
...
if __name__ == '__main__':
    ...
    python_ta.check_all(config={
        ...
        'disable': ['R0914', 'E1101', 'C0301'],
        'allowed-io': ['BytePairTokenizer.train'],
        'max-line-length': 120,
    })
